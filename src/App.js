...
function App() {
  return (
    <div className="App">
        ...
        <img src={bottomAnim1} className="bottom anim1" alt="top" />
        <img src={bottomAnim2} className="bottom anim2" alt="top" />
        <img src={bottomAnim3} className="bottom anim3" alt="top" />
        <img src={bottomAnim4} className="bottom anim4" alt="top" />
